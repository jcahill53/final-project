    ...
    return (
        <section>
            <section>
                ...
                <p className="marvel-link"><span></span>Learn more about this hero in the <span></span> <a className="marvel-link"  href={heroDetails[0].urls[1].url} target="_blank" rel="noreferrer">Marvel Universe</a></p>
            </section>
            <section>
